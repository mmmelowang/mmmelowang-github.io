...
2. Network of bars in Las Vegas
  ...
  Double click the bubble, and you can see the neighborhood of this bar, and its most similar bar.
...
r50 <- r50[, c("business_id", "user_id", "name", "neighborhood", "review_count")]
...
barnode <- r50[, c("barnum", "neighborhood", "review_count", "name")]      %>% 
     distinct()
